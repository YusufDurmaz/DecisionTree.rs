/* @ts-self-types="./decision_tree.d.ts" */

/**
 * @param {any} js_data
 * @param {any} features
 * @param {any} target_classes
 * @param {number} max_depth
 * @param {number} min_samples_split
 * @returns {any}
 */
export function generate_decision_tree(js_data, features, target_classes, max_depth, min_samples_split) {
    const ret = wasm.generate_decision_tree(js_data, features, target_classes, max_depth, min_samples_split);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('decision_tree_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
